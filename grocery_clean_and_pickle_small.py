...
for line in csv_file:
    ...
    if entry_counter % 20000000 == 0:
        ...
        counter_ref = str(counter)
        #name_train = "Cleaned_Training_Data" + counter_ref + ".pickle"
        #name_label = "Cleaned_Training_Labels" + counter_ref + ".pickle"
        print("Pickling Data : ", name_train, name_label)

        Train_out = open("Cleaned_Training_Data.pickle" , "ab")
        pickle.dump(Train_list, Train_out)
        Train_out.close()

        Label_out = open("Cleaned_Training_Labels.pickle" , "ab")
