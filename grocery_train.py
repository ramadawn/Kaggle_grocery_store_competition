...
Train_data = np.reshape(1,Train_data.shape,1)
Test_data = np.reshape(1,Test_data.shape,1)
Train_labels = np.reshape(1,Test_labels.shape,1)
Test_labels = np.reshape(1,Test_labels.shape,1)
